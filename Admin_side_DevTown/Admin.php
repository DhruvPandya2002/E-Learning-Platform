...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <div class="card card-primary" id="admin_detail">
        <div class="card-header text-lg">
          <div class="container d-flex justify-content-between align-items-center">
            Admin Details
            <a href="admin_server.php"><button class="btn-success form-control elevation-1" id="btn_add_admin">Add admin</button></a>
          </div>
        </div>
        <div class="card-body">
          <table id="myTable" class="table table-bordered table-hover">
            ...
            <tbody>
              <?php
              $sql_display = "SELECT * FROM `admin` WHERE `a_flag` = '0'";
  ...
  <script>
    ...
    function myadmin() {
      ...
      var admin_detail = document.querySelector('#admin_detail');
      add_admin.style.display = 'block';
      admin_detail.style.display = 'none';
    }
