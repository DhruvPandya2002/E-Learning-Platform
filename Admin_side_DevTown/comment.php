    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="Logo/user_image.png" class="img-circle elevation-3" alt="User Image">
          </div>
          <div class="info">
        ...
        <div class="card-body">
          <table id="myTable" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              $sql_display = "SELECT * FROM `comment` WHERE `flag` = '0'";
              ...
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                  <tr>
                    ...
                    <td><a href="comment_server.php?delete_id=<?php echo $row['id']; ?>"><i class="fa-solid fa-trash" style="color: #ff0000;"></i></a></td>
                  </tr>
              <?php
                  $count++;
                }
