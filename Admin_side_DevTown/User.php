            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td><abbr title="Edit"><a href="user_activity.php?activity=<?php echo $row['user_id']; ?>"><i name="btn_course_edit" class="fas fa-user-edit text-lg" style="color: rgb(5, 182, 5); cursor: pointer;"></i></a></abbr>
                    </td>
                  </tr>
              <?php
                  $count++;
