      ...
      <div class="card card-primary" id="blog_detail">
        <div class="card-header text-lg">
          <div class="container d-flex justify-content-between align-items-center">
            Course Detail
            <a href="Course_server-1.php" class="col-lg-2"><button class="btn-success form-control  elevation-1" id="btn_add_admin">Add Course</button></a>
          </div>
        </div>
        <div class="card-body">
            ...
            <tbody>
              ...
              ?>
                  <tr>
                    ...
                    <td><img src="Images/Course_image/<?php echo $row['c_Photo']; ?>" alt="<?php $row['c_Photo']; ?>" width="70px" /></td>
                    <td><?php echo $row['c_InsertedBy']; ?></td>
                    <td><span><a href="Course_server-1.php?updateid=<?php echo $row['c_Id']; ?>"><i name="btn_course_edit" class="fas fa-user-edit text-lg" style="color: rgb(5, 182, 5);"></i></a></span>
                      <span><abbr title="Delete"><a class="del_id"><i class="fas fa-trash text-lg ml-4" style="color: red; cursor:pointer;"></i></a></abbr></span>
                    </td>
                    <input type="hidden" class="delete_id" id="delete_id" value="<?php echo $row['c_Id']; ?>">
                  </tr>
              <?php
                  $count++;
                }
