...
if (isset($_POST['btn_course'])) {
    ...
    $course_insert = "INSERT INTO `premium`(`course_name`,`image`,`insertedBy`,`flag`)VALUES('$course_title','$course_image','$_SESSION[admin]',0)";
    if (mysqli_query($con, $course_insert)) {
        $_SESSION['status'] = 'Course Added';
        $_SESSION['status_code'] = 'success';
        header('location:premium_course.php'); // redirecting 
    } else {
...
if (isset($_POST['btn_update'])) {
    ...
    $query = "UPDATE `premium` SET `course_name`= '$update_course_title',`image`='$update_course_image',`insertedBy`='$_SESSION[User]' WHERE `id` = '$updateid'";
...
if (isset($_POST['delete_btn_set'])) {
    ...
    $sql = "UPDATE `premium` SET `flag`='1'  WHERE `id` = '$del_id'";
