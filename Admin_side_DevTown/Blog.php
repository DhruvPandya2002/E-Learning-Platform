      ...
      <div class="card card-primary" id="blog_detail">
        <div class="card-header text-lg">
          <div class="container d-flex justify-content-between align-items-center">
            Blog Detail
            <a href="blog_server.php"><button class="btn-success form-control elevation-1" id="btn_add_admin" onclick="myBlog()">Add Blog</button></a>
          </div>
        </div>
        <div class="card-body">
              ...
              if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                  <tr>
                    ...
                    <input type="hidden" class="delete_id" id="delete_id" value="<?php echo $row['Blog_id']; ?>">
                  </tr>
              <?php
                  $count++;
                }
