        ...
        <div class="fixed z-[9999] w-full">
            ...
            <div class="animate__animated animate__fadeIn animate__faster absolute top-full left-0 right-0 z-[9998] backdrop-blur-lg pt-[8vh] pb-[8vh] font-rubik md:hidden  opacity-1 pointer-events-auto visible transition-all duration-300 menu" style="background-color: rgba(255, 255, 255, 0.25); box-shadow: rgba(157, 157, 157, 0.2) 0px 4px 10px; display: none;">
                <ul class="flex flex-col items-center gap-y-6 md:hidden select-none">
                    ...
                    <li class="text-center text-xl sm:text-2xl"><a href="Blog.php">Blog</a></li>
                        ...
                        <div class="2xl:relative mx-auto min-h-[590px] max-w-[1300px] grid md:grid-cols-2 grid-cols-1 gap-4 md:gap-0">
                            <div class="flex flex-col gap-4 place-self-center py-14 px-8 max-w-[650px] text-[#fff] z-30">
                                <div>
                                    ...
                                    <h1 class="text-[42px] font-bold">Operating System </h1>
                                </div>
                                <p class="text-[20px] text-HeroSubText">
                                <p>Learning about operating systems can be <strong>beneficial</strong> for the future, as operating systems are essential components of modern <strong>computing systems.</strong> They manage 
                                    <strong>hardware and software resources</strong> and provide users with an interface to <strong>interact with the computer.</strong>
                                </p>
                                </p>
                            ...
                            <div class="relative w-full min-h-[200px] px-8 bottom-[135px] md:bottom-0">
                                <div class="rounded-2xl xl:mr-[75px] p-4 md:absolute md:bottom-[13rem] lg:bottom-[1.75rem] xl:-bottom-[60px] right-[1rem] min-h-[600px] max-w-[423px] mx-auto md:translate-y-0  translate-y-24 flex flex-col gap-4 bg-[#ffffffc2] border border-grey80 shadow-md shadow-grey100 backdrop-blur-md">
                                    ...
                                    <div class="px-4">
                                        ...
                                        <span class="text-[#363A45] line-through">₹4000</span>
                                        ...
                                        <div class="mt-4 text-headText">
                                            ...
                                            <div class="flex flex-col gap-3">
                                                ...
                                                <p class="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    </svg><span>OS - Beginner to Advanced</span></p>
                                                <p class="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z">
                                                        </path>
                                ...
                                <div class="mt-16">
                                    ...
                                    <div class="grid md:grid-cols-2 grid-cols-1 px-5 py-14 gap-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="text-[18px]">Introduction to Operating Systems</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Types of Operating Systems
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="text-[18px]">Multi-Tasking and Multi-Threading</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">System Call of Operating Systems</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Storage Use in Operating Systems</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Introduction to Process</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Context Switching</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Convoy Effect</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Priority Scheduling</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Multi Level Queue Scheduling</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Concurrency</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Critical Section Problems</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Reader - Writer problem's Solution</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Deadlock</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Memory management</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Paging</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Segmentation</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Virtual Memory</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Page replacement Algorithm</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Thrashing</div>
                                        </div> 
                                    </div>
                                </div>
                            </div>
