    ...
    <div class="layout-container">
      ...
      <div class="layout-page">
          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                <div class="navbar-nav align-items-center">
              <div class="nav-item d-flex align-items-center">
                <span class="app-brand-text text-capitalize fw-bolder fs-5 text-2xl text-[#30559E] font-medium">My Courses</span>
              </div>
            </div>
              </div>
            </div>
        ...
        <div class="content-wrapper">
          <!-- Content -->
          <div class="py-8 px-4 flex flex-col justify-center items-center gap-y-6 sm:py-12 sm:px-12 md:px-28 lg:grid lg:grid-cols-2 lg:gap-7 lg:place-items-start xl:mb-10 xl:gap-20 lg:py-6 2xl:w-fit">
                <?php
                    $sql = "SELECT * FROM `tbl_payment` LEFT JOIN `premium` ON `tbl_payment`.`product_name` = `premium`.`course_name` WHERE `tbl_payment`.`email` = '$email'";
                    $result = mysqli_query($con,$sql);
                    while($record_data = mysqli_fetch_assoc($result)){
                ?>
                <a href="course_content.php?premium_course_id=<?php echo $record_data['id'];?>&premium_course_name=<?php echo $record_data['course_name'];?>">
                <div class="bg-white rounded-lg shadow-xl 2xl:w-[28rem] flex flex-col justify-center items-center">
                    <div class="p-4 sm:p-8 lg:p-0">
                        <img src="../Logo/<?php echo $record_data['image'];?>" alt="<?php echo $record_data['image'];?>" class="rounded-xl">
                        <div class="flex justify-between mt-3">
                            <h3 class="text-lg sm:pt-3 sm:text-2xl md:text-3xl md:pt-6 md:pb-4 lg:pb-0 lg:text-xl pt-1 font-semibold xl:text-2xl text-gray-950">Learn <br>
                                <div>
                                    <p id="product_name"> <?php echo $record_data['course_name'];?> </p>
                                </div>
                            </h3>
                            <div>
