...
$result = mysqli_query($conn, "SELECT * FROM `comment` WHERE `content_id` = '$_SESSION[content_id]' and `course_id` = '$course_id' and `flag` = 0 and `parent_id` = '$reply_flag' ORDER BY `date` DESC");
