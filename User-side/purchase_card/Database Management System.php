...
<head>
    ...
    <meta name="title" content="Database Management System">
                        ...
                        <div class="2xl:relative mx-auto min-h-[590px] max-w-maxScreen grid md:grid-cols-2 grid-cols-1 gap-4 md:gap-0">
                            <div class="flex flex-col gap-4 place-self-center py-14 px-paddingXforMob max-w-[650px] text-[#fff] z-30">
                                <div>
                                    ...
                                    <h1 class="text-[42px] font-bold">Database Management System</h1>
                                </div>
                                <p class="text-[20px] text-HeroSubText">
                                <p>The field of database management is <strong>constantly</strong> evolving, and there is no doubt that it will continue to grow in <strong>importance</strong>in the future. As  
                                    <strong>technology advances</strong>, databases will become even more central to the way that businesses and organizations <strong>manage their information</strong>.
                                </p>
                                </p>
                            ...
                            <div class="relative w-full min-h-[200px] px-paddingXforMob bottom-[135px] md:bottom-0">
                                <div class="rounded-2xl xl:mr-[75px] p-4 md:absolute md:bottom-[13rem] lg:bottom-[1.75rem] xl:-bottom-[60px] right-[1rem] min-h-[600px] max-w-[423px] mx-auto md:translate-y-0  translate-y-24 flex flex-col gap-4 bg-[#ffffffc2] border border-grey80 shadow-md shadow-grey100 backdrop-blur-md">
                                    ...
                                    <div class="px-4">
                                        ...
                                        <span class="text-textHead line-through">₹6000</span>
                                        ...
                                        <div class="mt-4 text-headText">
                                            ...
                                            <div class="flex flex-col gap-3">
                                                ...
                                                <p class="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    </svg><span>DBMS - Beginner to Advanced</span></p>
                                                <p class="flex gap-2 items-center"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z">
                                                        </path>
                                ...
                                <div class="mt-16">
                                    ...
                                    <div class="grid md:grid-cols-2 grid-cols-1 px-5 py-14 gap-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div class="text-[18px]">Introduction to DBMS</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">DBMS Architecture
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="text-[18px]">ER Diagram Notation</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Abstraction in ER Model</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Relational Model</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Transform Model</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Structured Query Language</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Common SQL Queries</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Normalization</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">ACID Properties</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Implement Atomicity and Durability</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">NO SQL Databases</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Clustering and Replication</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Partitioning and Sharding</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Database Scaling Patterns</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">CAP Theorem</div>
                                        </div>
                                        <div class="flex items-center gap-4">
                                            <div class=""><svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 6.90742L6.02241 12L17 1" stroke="#30559E" stroke-width="2"></path>
                                                </svg></div>
                                            <div class="text-[18px]">Master Slave Architecture</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
