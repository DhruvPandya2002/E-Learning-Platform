...
if (isset($_POST['sub'])) {
  ...
  $sql="INSERT INTO `users` (`name`, `email`, `password`, `mobile`) VALUES ('$name','$email','$Mobileno','$password')";
  if(mysqli_query($con,$sql)){
    // header('location:User7.php');
      ...
      <div class="right bg-white p-5 rounded-b-xl sm:p-8 md:p-10 lg:rounded-bl-none lg:rounded-tr-xl xl:p-16 2xl:p-12">
        ...
        <form action="" method="POST">
          ...
          <div class="input text-lg flex flex-col relative sm:mt-4 lg:mt-4 xl:mt-3 2xl:mt-2">
            <input type="email" name="email" class="border border-gray-500 py-2 px-4 rounded-md focus:outline-[#30559E] mt-6 peer sm:h-20 sm:text-3xl lg:h-14 lg:text-2xl xl:h-14 xl:text-xl 2xl:w-[450px] 2xl:h-12 2xl:text-lg" placeholder="Enter Your Email..." />
          ...
          <div class="input text-lg flex flex-col relative sm:mt-4 lg:mt-4 xl:mt-3 2xl:mt-2">
            <input type="number" name="mobile" class="border border-gray-500 py-2 px-4 rounded-md focus:outline-[#30559E] mt-6 peer sm:h-20 sm:text-3xl lg:h-14 lg:text-2xl xl:h-14 xl:text-xl 2xl:w-[450px] 2xl:h-12 2xl:text-lg" placeholder="Enter Your Mobile No..." />
            <span class="absolute text-md mx-2 pl-1 pr-1 top-2 bg-white peer-focus:text-[#30559E] text-gray-500 sm:text-3xl sm:-top-0 lg:text-2xl
